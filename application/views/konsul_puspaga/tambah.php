<div class="container mt-3">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    <div class="card">
        ...
        <div class="card-body">
<form action="<?= base_url(); ?>Konsul_puspaga/tambah" method="post" enctype="multipart/form-data">
  ...
  <form class="form-group">
   <div class="form-group">
    ...
    <textarea class="form-control" id="perihal_konpus" name="perihal_konpus" rows="3"></textarea>
    <small class="form-text text-danger"><?= form_error('perihal_konpus'); ?></small>
  </div>
  <div class="form-group">
