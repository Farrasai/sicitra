<div class="breadcrumbs">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header"><strong>Form Edit Data Pelaku</strong></div>
                        <div class="card-body">                                
                            <form action="" method="post" class="">
                                <input type="hidden" name="id" value="<?= $pelaku['nik_pelaku'];?>">
                                <div class="row form-group">
                                    <div class="input-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">NIK</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nik_pelaku" name="nik_pelaku" placeholder="Masukkan NIK" class="form-control" value="<?= $pelaku ['nik_pelaku']; ?>">
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="id_aduan" name="id_aduan" placeholder="Masukkan ID Aduan" class="form-control" value="<?= $pelaku ['id_aduan']; ?>">
                                        <small class="form-text text-danger"><?= form_error('id_aduan'); ?></small></div>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nama_pelaku" name="nama_pelaku" placeholder="Masukkan Nama Lengkap" class="form-control" value="<?= $pelaku ['nama_pelaku']; ?>">
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmpt_lahir_pelaku" name="tmpt_lahir_pelaku" placeholder="Masukkan Tempat Lahir" class="form-control" value="<?= $pelaku ['tmpt_lahir_pelaku']; ?>">
                                        <small class="form-text text-danger"><?= form_error('tmpat_lahir_pelaku'); ?></small></div>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tgl_lahir_pelaku" name="tgl_lahir_pelaku" placeholder="Masukkan Tanggal Lahir" class="form-control" value="<?= $pelaku ['tgl_lahir_pelaku']; ?>">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <select name="jk_pelaku" id="jk_pelaku" class="form-control">
                                                <option><?= $pelaku ['jk_pelaku']; ?></option>
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="usia_pelaku" name="usia_pelaku" placeholder="Masukkan Usia" class="form-control" value="<?= $pelaku ['usia_pelaku']; ?>">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <select name="agama_pelaku" id="agama_pelaku" class="form-control">
                                                <option><?= $pelaku ['agama_pelaku']; ?></option>
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="alamat_pelaku" id="alamat_pelaku" rows="9"  class="form-control"><?= $pelaku ['alamat_pelaku']; ?></textarea></div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <select name="pendidikan_pelaku" id="pendidikan_pelaku" class="form-control">
                                                <option><?= $pelaku ['pendidikan_pelaku']; ?></option>
                                                <option value="-">-</option>
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="pekerjaan_pelaku" name="pekerjaan_pelaku" placeholder="Masukkan Pekerjaan" class="form-control" value="<?= $pelaku ['pekerjaan_pelaku']; ?>">
                                        <small class="form-text text-danger"><?= form_error('pekerjaan_pelaku'); ?></small></div>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="no_tlp_pelaku" name="no_tlp_pelaku" placeholder="Masukkan No Telepon" class="form-control" value="<?= $pelaku ['no_tlp_pelaku']; ?>"">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <select name="status_kawin_pelaku" id="status_kawin_pelaku" class="form-control">
                                                <option><?= $pelaku ['status_kawin_pelaku']; ?></option>
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <select name="difabel_pelaku" id="difabel_pelaku" class="form-control">
                                                <option><?= $pelaku ['difabel_pelaku']; ?></option>
