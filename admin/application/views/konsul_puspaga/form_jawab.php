<div class="breadcrumbs">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="<?php base_url(); ?>/admin/admin">Konsultasi Puspaga</a></li>
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header"><strong>Form Jawab Konsultasi Puspaga</strong></div>
                        <div class="card-body">                                
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="jawaban" name="jawaban" class="form-control" value="<?= $konsultasi_puspaga['jawaban']; ?>">
                                    </div>
                                </div>
