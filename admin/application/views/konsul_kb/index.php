                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><?php base_url(); ?>Konsultasi KB</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><strong>Data Konsultasi KB</strong></strong>
                            ...
                            <div class="card-body">
                                <div id="bootstrap-data-table_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            <td><?= $newDate; ?></td>
                                            <td><?= $kb['nik_pengadu']; ?></td>
                                            <td><?= $kb['username']; ?></td>
                                            <td><?= $kb['perihal_konkb']; ?></td>
                                            <td><?= $kb['jawaban']; ?></td>
                                            <td><a href="<?= base_url(); ?>Konsul_KB/detail/<?= $kb ['id_konkb']; ?>" class="badge badge-primary">Detail</a> <a href="<?= base_url(); ?>Konsul_KB/jawab/<?= $kb ['id_konkb']; ?>" class="badge badge-success">Jawab</a></td>
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog mt-sm-5">
      ...
      <div class="modal-content">
        ...
        <!-- body modal -->
        <form action="<?php echo base_url('Konsul_KB/cetak'); ?>" method="post">
